...
// // MiddlewareConfig represents a declarative middleware configuration
// type MiddlewareConfig struct {
// 	Name     string         `json:"name,omitempty"`
// 	Handler  StdMiddleware  `json:"-"`
// 	Metadata map[string]any `json:"metadata,omitempty"`
// }

// // MiddlewareConfigsToInterfaces converts []MiddlewareConfig to []MiddlewareInterface
// func MiddlewareConfigsToInterfaces(configs []MiddlewareConfig) []MiddlewareInterface {
// 	interfaces := make([]MiddlewareInterface, len(configs))
// 	for i, config := range configs {
// 		if config.Name != "" {
// 			interfaces[i] = NewMiddleware(config.Name, config.Handler)
// 		} else {
// 			interfaces[i] = NewAnonymousMiddleware(config.Handler)
// 		}
// 	}
// 	return interfaces
// }

// // InterfacesToMiddlewareConfigs converts []MiddlewareInterface to []MiddlewareConfig
// func InterfacesToMiddlewareConfigs(interfaces []MiddlewareInterface) []MiddlewareConfig {
// 	configs := make([]MiddlewareConfig, len(interfaces))
// 	for i, iface := range interfaces {
// 		configs[i] = MiddlewareConfig{
// 			Name:    iface.GetName(),
// 			Handler: iface.GetHandler(),
// 		}
// 	}
// 	return configs
// }

// // NewMiddlewareConfig creates a new MiddlewareConfig
...
// // StdMiddlewaresToConfigs converts []StdMiddleware to []MiddlewareConfig with anonymous names
...
// 	BeforeMiddleware []MiddlewareConfig `json:"before_middleware,omitempty"`
// 	AfterMiddleware  []MiddlewareConfig `json:"after_middleware,omitempty"`
// 	Metadata         map[string]any     `json:"metadata,omitempty"`
// }
...
// 		router.AddBeforeMiddlewares(MiddlewareConfigsToInterfaces(config.BeforeMiddleware))
// 	}
// 	if len(config.AfterMiddleware) > 0 {
// 		router.AddAfterMiddlewares(MiddlewareConfigsToInterfaces(config.AfterMiddleware))
// 	}
...
// 	}
// 	if len(config.BeforeMiddleware) > 0 {
// 		route.AddBeforeMiddlewares(MiddlewareConfigsToInterfaces(config.BeforeMiddleware))
// 	}
// 	if len(config.AfterMiddleware) > 0 {
// 		route.AddAfterMiddlewares(MiddlewareConfigsToInterfaces(config.AfterMiddleware))
// 	}
...
// 	}
// 	if len(config.BeforeMiddleware) > 0 {
// 		group.AddBeforeMiddlewares(MiddlewareConfigsToInterfaces(config.BeforeMiddleware))
// 	}
// 	if len(config.AfterMiddleware) > 0 {
// 		group.AddAfterMiddlewares(MiddlewareConfigsToInterfaces(config.AfterMiddleware))
// 	}
...
// 	if len(config.BeforeMiddleware) > 0 {
// 		domain.AddBeforeMiddlewares(MiddlewareConfigsToInterfaces(config.BeforeMiddleware))
// 	}
// 	if len(config.AfterMiddleware) > 0 {
// 		domain.AddAfterMiddlewares(MiddlewareConfigsToInterfaces(config.AfterMiddleware))
// 	}
...
// func (r RouteConfig) WithBeforeMiddleware(middleware ...MiddlewareConfig) RouteConfig {
...
// func (r RouteConfig) WithAfterMiddleware(middleware ...MiddlewareConfig) RouteConfig {
...
// func (g GroupConfig) WithBeforeMiddleware(middleware ...MiddlewareConfig) GroupConfig {
...
// func (g GroupConfig) WithAfterMiddleware(middleware ...MiddlewareConfig) GroupConfig {
...
// 	r.BeforeMiddleware = append(r.BeforeMiddleware, InterfacesToMiddlewareConfigs(middleware)...)
// 	return r
// }
...
// 	return MiddlewareConfigsToInterfaces(r.BeforeMiddleware)
// }
...
// 	r.AfterMiddleware = append(r.AfterMiddleware, InterfacesToMiddlewareConfigs(middleware)...)
// 	return r
// }
...
// 	return MiddlewareConfigsToInterfaces(r.AfterMiddleware)
// }
...
// 			BeforeMiddleware: InterfacesToMiddlewareConfigs(route.GetBeforeMiddlewares()),
// 			AfterMiddleware:  InterfacesToMiddlewareConfigs(route.GetAfterMiddlewares()),
// 			Metadata:         make(map[string]any),
// 		}
// 		g.Routes = append(g.Routes, routeConfig)
// 	}
...
// 			Routes:           []RouteConfig{},
// 			Groups:           []GroupConfig{},
// 			BeforeMiddleware: InterfacesToMiddlewareConfigs(group.GetBeforeMiddlewares()),
// 			AfterMiddleware:  InterfacesToMiddlewareConfigs(group.GetAfterMiddlewares()),
// 		}
// 		// Convert routes
...
// 	g.BeforeMiddleware = append(g.BeforeMiddleware, InterfacesToMiddlewareConfigs(middleware)...)
// 	return g
// }
...
// 	return MiddlewareConfigsToInterfaces(g.BeforeMiddleware)
// }
...
// 	g.AfterMiddleware = append(g.AfterMiddleware, InterfacesToMiddlewareConfigs(middleware)...)
// 	return g
// }
...
// 	return MiddlewareConfigsToInterfaces(g.AfterMiddleware)
// }
...
// 	d.BeforeMiddleware = append(d.BeforeMiddleware, InterfacesToMiddlewareConfigs(middleware)...)
// 	return d
// }
...
// 	return MiddlewareConfigsToInterfaces(d.BeforeMiddleware)
// }
...
// 	d.AfterMiddleware = append(d.AfterMiddleware, InterfacesToMiddlewareConfigs(middleware)...)
// 	return d
// }
...
// 	return MiddlewareConfigsToInterfaces(d.AfterMiddleware)
// }
