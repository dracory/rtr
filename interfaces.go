...
type RouteInterface interface {
	...
	// SetController sets the controller for this route and returns the route for method chaining.
	SetController(controller ControllerInterface) RouteInterface

	// GetHTMLController returns the HTML controller associated with this route.
	GetHTMLController() HTMLControllerInterface
	// SetHTMLController sets the HTML controller for this route and returns the route for method chaining.
	SetHTMLController(controller HTMLControllerInterface) RouteInterface

	// GetJSONController returns the JSON controller associated with this route.
	GetJSONController() JSONControllerInterface
	// SetJSONController sets the JSON controller for this route and returns the route for method chaining.
	SetJSONController(controller JSONControllerInterface) RouteInterface

	// GetTextController returns the text controller associated with this route.
	GetTextController() TextControllerInterface
	// SetTextController sets the text controller for this route and returns the route for method chaining.
	SetTextController(controller TextControllerInterface) RouteInterface
}
